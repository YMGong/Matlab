...
switch varargin{1}
    case 'find_centerline_twopoints'
        ...
        terminus, PointE, step, edge_cutoff, maxdelta);
...
function centerPoint = ...
    find_centerline_twopoints(mask, xcoor, ycoor, terminus, PointE, step, edge_cutoff, maxdelta, varargin)
...
for r= 4:step:n
    ...
    c_first = 0;
    sp = 1;
    while sqrt( (r_first - r_last)^2 + (c_last - c_first)^2 ) < edge_cutoff
        FirstI = 0;
        for k = sp:length(c_new)
